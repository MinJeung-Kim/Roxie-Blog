...
let posts: Post[] = [
  {
    ...
    updatedAt: new Date(),
    image:
      "https://cdn.sanity.io/images/sstznhcv/production/c3d01c4d1fcbc94350bbb36b0477f13d5784d1b3-1792x1024.png?w=800",
    createdAt: new Date(),
    category: "CSS",
    description:
      "CSS-in-JS의 한계와 불편한 점과 SCSS의 사용방법에 대해 알아본다.",
  },
  {
    updatedAt: new Date(),
    description: "Vercel 배포 시, .env 설정 누락으로 인한 에러 해결.",
    image:
      "https://cdn.sanity.io/images/sstznhcv/production/6d78dec2f1fd7371f87895b48e3797f367cead42-1792x1024.png?w=800",
...
export async function create(createData: {
  title: string;
  description: string;
  category: string;
  content: string;
...
export async function update(
  ...
  const { title, description, category, content, image } = updateData;
